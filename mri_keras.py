...
def mri_keras(main_dir, data_dir, report_dir, input_str,  ext, labelName, covPath, ratios=[0.75,0.15], batch_size=2, feature_dim=2, pad_base=0, createDataset=True):

    #setup_dirs(target_dir)

    imagesDf = prepare_data(main_dir, data_dir, report_dir, input_str, ext, labelName, covPath, ratios, batch_size, feature_dim, pad_base)
